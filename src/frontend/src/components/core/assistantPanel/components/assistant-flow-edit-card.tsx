...
function FlowEditCard({
  ...
  const emptyLabel = t("assistant.flowEdit.emptyValue");
    ...
    <div className="flex flex-col gap-2">
      <div className="flex flex-col gap-0.5">
        ...
        {isLong && (
          ...
          >
            {expanded
              ? t("assistant.flowEdit.showLess")
              : t("assistant.flowEdit.showMore")}
          </button>
        )}
      </div>
      ...
      <div className="mb-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          {pendingCount > 1 && (
            ...
            >
              {t("assistant.flowEdit.acceptAll", { total: pendingCount })}
            </button>
          )}
        </div>
      </div>

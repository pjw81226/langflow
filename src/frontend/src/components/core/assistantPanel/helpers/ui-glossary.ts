...
const GLOSSARY_KEYS = [
  ...
  "assistant.test.fixIt",
  "assistant.test.passed",
  "assistant.test.passedFixed",
  "assistant.test.failed",
  "assistant.test.needsAttention",
  "assistant.test.notTested",
  "assistant.test.details",
  "assistant.autoApply.label",
  "assistant.menu.more",
  "assistant.dock.dock",
  "assistant.dock.undock",
  "assistant.close",
  "assistant.newSession",
  "assistant.flowPreview.addToCanvas",
  "assistant.flowPreview.replaceCanvas",
  "assistant.flowPreview.revert",
  "assistant.flowEdit.accept",
  "assistant.dismiss",
  "assistant.continue",

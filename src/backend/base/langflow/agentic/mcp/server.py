...
serves the single lfx toolkit (``lfx.mcp.server``), where every tool call goes
through the REST API with the caller's credentials. The per-user auto-configuration that used to register
